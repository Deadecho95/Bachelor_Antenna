...
#if (PORT_RTOS_KEIL != 0)
	#define USE_XF_DISPATCHER_ACTIVE_DEFAULT_IMPLEMENTATION           1
	#define USE_XF_PORT_RTOS_KEIL_RESOURCE_FACTORY_IMPLEMENTATION     1
	#define USE_XF_PORT_RTOS_KEIL_TIMEOUTMANAGER_IMPLEMENTATION       1
	#define USE_XF_PORT_RTOS_KEIL_EVENT_QUEUE_IMPLEMENTATION          1
	#define USE_XF_PORT_RTOS_KEIL_THREAD_IMPLEMENTATION               1
	#define USE_XF_PORT_RTOS_KEIL_MUTEX_IMPLEMENTATION               1

    #define XFTHREAD_DEFAULT_STACK_SIZE                                              512

	#include "stm32-rtos2-keil/eventqueue.h"
#endif // PORT_STM32CUBE_CMSIS_FREERTOS
