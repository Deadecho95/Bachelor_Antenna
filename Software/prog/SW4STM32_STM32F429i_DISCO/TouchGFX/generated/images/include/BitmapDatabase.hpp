...
const uint16_t BITMAP_BLUE_PROGRESSINDICATORS_BG_MEDIUM_PROGRESS_INDICATOR_BG_SQUARE_90_DEGREES_ID = 2; // Size: 20x184 pixels
const uint16_t BITMAP_PEABODY_ID = 3; // Size: 140x138 pixels
